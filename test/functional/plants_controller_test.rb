...
class PlantsControllerTest < ActionController::TestCase
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post :create, plant: { description: @plant.description, name: @plant.name, status_id: @plant.status_id }
    end
  ...
  test "should update plant" do
    put :update, id: @plant, plant: { description: @plant.description, name: @plant.name, status_id: @plant.status_id }
    assert_redirected_to plant_path(assigns(:plant))
  end
