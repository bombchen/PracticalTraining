...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { comments: @facility.comments, count: @facility.count, description: @facility.description, name: @facility.name, unit: @facility.unit }
    end
  ...
  test "should update facility" do
    put :update, id: @facility, facility: { comments: @facility.comments, count: @facility.count, description: @facility.description, name: @facility.name, unit: @facility.unit }
    assert_redirected_to facility_path(assigns(:facility))
  end
