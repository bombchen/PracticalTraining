...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { available: @field.available, description: @field.description, name: @field.name, status: @field.status }
    end
  ...
  test "should update field" do
    put :update, id: @field, field: { available: @field.available, description: @field.description, name: @field.name, status: @field.status }
    assert_redirected_to field_path(assigns(:field))
  end
